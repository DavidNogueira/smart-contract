...
contract Crowdsale is Pausable, PullPayment {
	...
	* Variables
	*/
	/* Substratum contract reference */
	SubstratumCoin public coin;
    /* Multisig contract that will receive the Ether */
	address public multisigEther;
	/* Number of Ether received */
	uint public etherReceived;
	/* Number of SubstratumCoins sent to Ether contributors */
	...
	*/
	 ...
	 * Constructor
	*/
	function Crowdsale(address _subCoinAddress, address _to) {
		coin = SubstratumCoin(_subCoinAddress);
		multisigEther = _to;
	}
